...
pal <- c("#8C1515", "#E98300", "#007C92") # alternative 1 from Jakob
# pal <- c("#1b9e77", "#d95f02", "#7570b3") # alternative 2 from color brewer
# pal <- paletteer_d("ggthemes::wsj_rgby")[c(2,3,4)] # alternative 3 from paletteer wsj
# pal <- paletteer_d("fishualize::Pseudochromis_aldabraensis")[c(2,4,5)] 
# pal <- c("#DDAA33", "#BB5566", "#004488")
